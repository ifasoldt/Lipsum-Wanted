...
type_natural = ARGV[0]
if type_natural == nil
  abort ("I'm sorry, you need to make a choice of lipsum between 'Hipster', 'NotLorem', and 'Fillerama'")
end
type = type_natural.downcase
...
system("echo #{Shellwords.escape(generated[0])} | pbcopy")
elsif type == "notlorem"
  while paragraph_num > i
